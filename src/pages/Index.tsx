        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-neon/20 border border-neon/40 px-4 py-2 mb-6 rounded-sm"
            >
              <Zap className="w-4 h-4 text-neon" />
              <span className="text-neon font-body text-sm font-semibold tracking-wider uppercase">New Arrivals 2026</span>
            </motion.div>
            <h1 className="heading-display text-6xl md:text-8xl lg:text-9xl font-bold leading-[0.9] mb-6 text-primary-foreground">
              FUEL YOUR<br />
              <span className="text-neon text-glow">GAME</span>
            </h1>
            <p className="text-primary-foreground/70 font-body text-lg md:text-xl mb-8 max-w-lg">
              Authentic Nike, Adidas, Puma & more. Delivered to your door in Kuwait.
            </p>
            <div className="flex gap-4 flex-wrap">
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 bg-neon text-accent-foreground px-8 py-4 font-body text-sm font-bold tracking-widest uppercase hover:bg-neon-glow transition-all duration-300 glow-neon rounded-sm"
              >
                Shop Now <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                to="/shop?category=running"
                className="inline-flex items-center gap-2 border border-primary-foreground/30 text-primary-foreground px-8 py-4 font-body text-sm font-bold tracking-widest uppercase hover:border-neon hover:text-neon transition-all duration-300 rounded-sm"
              >
                Running Collection
              </Link>
            </div>
