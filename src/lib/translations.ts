...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    'checkout.step_info': 'معلوماتك',
    'checkout.step_shipping': 'الشحن',
    'checkout.step_review': 'المراجعة',
    'checkout.next': 'متابعة',
    'checkout.back': 'رجوع',
    'checkout.name_required': 'الاسم مطلوب',
    'checkout.phone_required': 'رقم الهاتف مطلوب',
    'checkout.phone_invalid': 'أدخل رقم هاتف صحيح (8 أرقام أو أكثر)',
    'checkout.address_required': 'العنوان مطلوب',
    'checkout.review_title': 'مراجعة طلبك',
    'checkout.edit': 'تعديل',
    'checkout.items_count': 'منتجات',
